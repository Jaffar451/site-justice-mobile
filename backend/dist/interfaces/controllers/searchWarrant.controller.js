...
const searchWarrant_model_1 = __importDefault(require("../../models/searchWarrant.model"));
const createSearchWarrant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const warrant = yield searchWarrant_model_1.default.create(req.body);
...
const getSearchWarrants = (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    const warrants = yield searchWarrant_model_1.default.findAll();
    res.json(warrants);
});
