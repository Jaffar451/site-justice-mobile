...
let CaseParty = class CaseParty extends sequelize_typescript_1.Model {
};
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => case_model_1.default),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: false }),
    __metadata("design:type", Number)
], CaseParty.prototype, "caseId", void 0);
__decorate([
...
__decorate([
    ...
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: false }),
    __metadata("design:type", Number)
], CaseParty.prototype, "personId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => person_model_1.default, { as: 'person' }),
    __metadata("design:type", person_model_1.default)
], CaseParty.prototype, "person", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM('defendant', 'victim', 'civil_party', 'witness'),
        allowNull: false
    }),
...
__decorate([
    ...
    __metadata("design:type", Number)
], CaseParty.prototype, "representedById", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_model_1.default, { as: 'lawyer' }),
    __metadata("design:type", user_model_1.default)
], CaseParty.prototype, "lawyer", void 0);
__decorate([
...
], CaseParty.prototype, "addedAt", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.TEXT, allowNull: true }),
    __metadata("design:type", String)
], CaseParty.prototype, "notes", void 0);
__decorate([
    sequelize_typescript_1.CreatedAt,
    __metadata("design:type", Date)
], CaseParty.prototype, "createdAt", void 0);
__decorate([
    sequelize_typescript_1.UpdatedAt,
    __metadata("design:type", Date)
], CaseParty.prototype, "updatedAt", void 0);
CaseParty = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'CaseParties', timestamps: true, underscored: true })
], CaseParty);
exports.default = CaseParty;
