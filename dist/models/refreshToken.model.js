...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_model_1.default, { as: 'account' }),
...
RefreshToken = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'refresh_tokens', timestamps: true, underscored: true })
], RefreshToken);
