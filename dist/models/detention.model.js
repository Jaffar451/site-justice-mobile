...
let Detention = class Detention extends sequelize_typescript_1.Model {
};
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => person_model_1.default),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: false }),
    __metadata("design:type", Number)
], Detention.prototype, "suspectId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => person_model_1.default, { as: 'suspect' }),
    __metadata("design:type", person_model_1.default)
], Detention.prototype, "suspect", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => decision_model_1.default),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: false }),
    __metadata("design:type", Number)
], Detention.prototype, "decisionId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => decision_model_1.default, { as: 'decision' }),
    __metadata("design:type", decision_model_1.default)
], Detention.prototype, "decision", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => case_model_1.default),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: true }),
    __metadata("design:type", Number)
], Detention.prototype, "caseId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => case_model_1.default, { as: 'case' }),
    __metadata("design:type", case_model_1.default)
], Detention.prototype, "case", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.DATE, allowNull: false }),
    __metadata("design:type", Date)
], Detention.prototype, "dateDebut", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.DATE, allowNull: true }),
    __metadata("design:type", Date)
], Detention.prototype, "dateFin", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM('provisoire', 'ferme', 'terminée', 'annulée'),
        defaultValue: 'provisoire'
    }),
    __metadata("design:type", String)
], Detention.prototype, "status", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.TEXT, allowNull: false }),
    __metadata("design:type", String)
], Detention.prototype, "motif", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], Detention.prototype, "lieuDetention", void 0);
__decorate([
    sequelize_typescript_1.CreatedAt,
    __metadata("design:type", Date)
], Detention.prototype, "createdAt", void 0);
__decorate([
    sequelize_typescript_1.UpdatedAt,
    __metadata("design:type", Date)
], Detention.prototype, "updatedAt", void 0);
Detention = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'Detentions', timestamps: true, underscored: true })
], Detention);
