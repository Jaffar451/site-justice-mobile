...
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM('amener', 'dépôt', 'arrestation'),
        allowNull: false
    }),
...
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM('émis', 'exécuté', 'annulé'),
        defaultValue: 'émis'
    }),
    __metadata("design:type", String)
...
], Warrant.prototype, "targetPersonId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => person_model_1.default, { as: 'targetPerson' }),
    __metadata("design:type", person_model_1.default)
], Warrant.prototype, "targetPerson", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => user_model_1.default),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: false }),
    __metadata("design:type", Number)
], Warrant.prototype, "issuedBy", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_model_1.default, { as: 'issuedByUser' }),
    __metadata("design:type", user_model_1.default)
], Warrant.prototype, "issuedByUser", void 0);
__decorate([
...
], Warrant.prototype, "issuedAt", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.DATE, allowNull: true }),
    __metadata("design:type", Date)
], Warrant.prototype, "executedAt", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.TEXT, allowNull: false }),
    __metadata("design:type", String)
], Warrant.prototype, "reason", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => complaint_model_1.default),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: true }),
    __metadata("design:type", Number)
], Warrant.prototype, "relatedComplaintId", void 0);
__decorate([
...
], Warrant.prototype, "complaint", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => case_model_1.default),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: true }),
    __metadata("design:type", Number)
], Warrant.prototype, "relatedCaseId", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Date)
], Warrant.prototype, "createdAt", void 0);
__decorate([
    sequelize_typescript_1.UpdatedAt,
    __metadata("design:type", Date)
], Warrant.prototype, "updatedAt", void 0);
Warrant = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'Warrants', timestamps: true, underscored: true })
], Warrant);
