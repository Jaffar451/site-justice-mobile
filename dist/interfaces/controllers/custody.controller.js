...
exports.deleteCustody = exports.updateCustody = exports.getCustody = exports.getActiveCustodies = exports.getAllCustodies = exports.createCustody = void 0;
const createCustody = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const custody = yield, create;
        (req.body);
...
// 🔴 CORRECTION ICI : 'en_cours' au lieu de 'active'
const getActiveCustodies = (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const custodies = yield, findAll;
        ({
            where: {
                status: 'en_cours' // ✅ Valeur valide de l'ENUM PostgreSQL
            },
            order: [['startedAt', 'DESC']] // 🟢 Bonus: Tri par date de début
        });
        return res.json(custodies);
    }
    catch (err) {
        console.error("❌ Erreur getActiveCustodies:", err);
        return res.status(500).json({ message: "Erreur récupération custodies actives", error: err });
    }
});
exports.getActiveCustodies = getActiveCustodies;
const getCustody = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const custody = yield, findByPk;
        (req.params.id);
        if (!custody)
