...
const createSummon = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const complaint = yield, findByPk;
        (data.complaintId);
        if (!complaint)
            return res.status(404).json({ message: "Plainte introuvable" });
        const summon = yield, create;
        (Object.assign(Object.assign({}, data), { scheduledAt: new Date(data.scheduledAt), issuedBy: officerId }));
