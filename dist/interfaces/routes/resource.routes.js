...
const ResourceController = __importStar(require("../controllers"));
const auth_middleware_1 = require("../../middleware/auth.middleware");
const router = (0, express_1.Router)();
// Routes protégées pour l'application
router.get("/legal-texts", auth_middleware_1.authenticate, ResourceController.getLegalTexts);
router.get("/lawyers", auth_middleware_1.authenticate, ResourceController.getLawyers);
