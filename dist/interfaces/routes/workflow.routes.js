...
const workflowController = __importStar(require("../controllers"));
...
const prosecutorAccess = [auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(["admin", "prosecutor"])];
