...
const seedDatabase = async () => {
    try {
        ...
        // 1. INFRASTRUCTURES
        // ==========================================
        const central = await models_1.PoliceStation.create({
        ...
        const tgi = await models_1.Court.create({
        ...
        const prison = await models_1.Prison.create({
        ...
        // 👮 POLICE - OPJ
        const opj = await models_1.User.create({
            firstname: "Ibrahim",
            lastname: "Agent",
            email: "opj@police.ne",
            password: passwordHash,
        ...
        const commissaire = await models_1.User.create({
            firstname: "Abdoulaye",
        ...
        // ⚖️ JUSTICE - PROCUREUR
        const procureur = await models_1.User.create({
            firstname: "Fatouma",
            lastname: "Procureur",
        ...
        // ⚖️ JUSTICE - JUGE
        const juge = await models_1.User.create({
            firstname: "Sani",
            lastname: "Juge",
        ...
        // 🙎‍♂️ CITOYEN
        const citizen = await models_1.User.create({
            firstname: "Amadou",
            lastname: "Kouka",
        ...
        // 3. DONNÉES DE DÉMO
        // ==========================================
        await models_1.Complaint.create({
            citizenId: citizen.id,
            policeStationId: central.id,
            title: "Vol de moto",
            description: "Ma moto Kasea a été volée au grand marché hier soir vers 18h.",
            category: "Vol",
            status: "soumise",
            filedAt: new Date(),
