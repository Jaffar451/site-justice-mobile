...
export const usersData = [
  ...
  },
  {
    ...
    matricule: "POL001",
    poste: "Commissaire de Police",
  },
  {
    key: "inspecteur",
    firstname: "Aïcha",
    lastname: "Ibrahim",
    email: "inspecteur@police.ne",
    role: "police",
    phone: "+227 90 00 00 03",
    matricule: "POL002",
    poste: "Inspecteur OPJ",
  },
  {
    key: "procureur",
    firstname: "Hassan",
    ...
    role: "prosecutor",
    phone: "+227 90 00 00 04",
    matricule: "PROC001",
    poste: "Procureur de la République",
  },
  {
    key: "substitut",
    firstname: "Fatima",
    lastname: "Moussa",
    email: "substitut@justice.ne",
    role: "prosecutor",
    phone: "+227 90 00 00 05",
    matricule: "PROC002",
  ...
  },
  {
    ...
    firstname: "Amadou",
    lastname: "Seydou",
    email: "juge.instruction@justice.ne",
    role: "judge",
    phone: "+227 90 00 00 06",
    matricule: "JUG001",
    poste: "Juge d'Instruction",
  },
  {
    key: "jugeSiege",
    firstname: "Mariama",
    lastname: "Ali",
    email: "juge.siege@justice.ne",
    role: "judge",
    phone: "+227 90 00 00 07",
    matricule: "JUG002",
    poste: "Juge du Siège",
  },
  {
    ...
    firstname: "Abdoulaye",
    lastname: "Mamane",
    email: "greffier@justice.ne",
    role: "clerk",
    phone: "+227 90 00 00 08",
    matricule: "GREF001",
    poste: "Greffier en Chef",
  },
  {
    key: "avocat",
    firstname: "Khadija",
    lastname: "Issoufou",
    email: "avocat@barreau.ne",
    role: "lawyer",
    phone: "+227 90 00 00 09",
    matricule: "AV001",
    poste: "Avocat au Barreau",
  },
  {
    key: "gardien",
    firstname: "Ousmane",
    lastname: "Hamidou",
    email: "gardien@prison.ne",
    role: "prison_officer",
    phone: "+227 90 00 00 10",
    matricule: "PRIS001",
    poste: "Agent Pénitentiaire",
  },
  {
    key: "citoyen1",
    firstname: "Ibrahim",
...
export const complaintsData = [
  {
    ...
    citizenKey: "citoyen1",
    description:
      "Vol à main armée dans un commerce au quartier Terminus. Trois individus armés ont emporté environ 2 millions de FCFA.",
    status: "en_cours_OPJ",
  ...
  },
  {
    ...
    citizenKey: "citoyen2",
    description:
      "Agression physique suite à un différend entre voisins. Coups et blessures volontaires.",
  ...
  },
  {
    ...
    citizenKey: "citoyen1",
    description:
      "Escroquerie via les réseaux sociaux. Vente de faux produits électroniques pour un montant de 500 000 FCFA.",
    status: "soumise",
